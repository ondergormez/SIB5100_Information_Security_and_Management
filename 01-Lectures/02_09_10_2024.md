...
## Data Breaches
* Yahoo 3 milyar kullanıcının bilgileri çaldırdı. Password lerin çalındığı söyleniyor.
* Marriott, Starwood Hotels i satın aldı. Bu otelin 500 milyon müşteri bilgisi çalındı.
* Twitter Mayıs 2018 de şifrelenmemiş bir log dosyasında user ların password lerini sakladığı ve çalındığı açıklandı.
